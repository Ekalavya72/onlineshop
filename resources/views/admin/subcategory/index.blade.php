									...
									<tbody>
										...
										<tr>
											...
											<td>
												...
												<a href="\"  data-bs-toggle="modal" data-bs-target="#exampleModal{{$subcategory->id}}"> <i class="fa-solid fa-trash"></i> </a>
													...
													<div class="modal-dialog ">
														<div class="modal-content">
															...
															<div class="modal-footer">
																...
																<form action="{{route('subcategory.destroy', $subcategory->id)}}" method="POST" enctype="multipart/form-data">
																	@csrf
																	@method('delete')
