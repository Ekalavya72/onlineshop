                            ...
                            <div class="card">
                                <div class="card-body">								
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="slug">Brand's Slug</label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <a href="{{asset('uploads/brand/image/'.$brands->image)}}">
                                                        <img src="{{ asset('uploads/brand/image/'. $brands->image)}}" alt="img" class="img-thumbnail" style="max-width: 40px; max-height: 40px;">
